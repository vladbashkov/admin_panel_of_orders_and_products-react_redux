const ProductsListItem = ({
  ...
  return (
    <li className="card flex-row mb-4 shadow-lg text-dark p-3">
      <img
        src="https://www.sacbee.com/reviews/wp-content/uploads/2022/06/spectre-sacramento.jpg"
      ...
      <div className="card-body d-flex justify-content-between">
        <div className="card-body_text w-100">
          ...
          <p
            className={`card-text ${
              isNew === "new" ? "text-success" : "text-warning"
            }`}
          >{`${isNew.charAt(0).toUpperCase() + isNew.slice(1)}`}</p>
