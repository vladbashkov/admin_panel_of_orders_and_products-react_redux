...
const ProductsList = () => {
    ...
    return (
        <div className='mb-3 card-body'>
            <button className="btn btn-success mb-3 btn-lg btn-block w-100" type="button" data-bs-toggle="collapse" data-bs-target="#collapseForm" aria-expanded="false" aria-controls="collapseForm">
                Add New Product
            </button>
